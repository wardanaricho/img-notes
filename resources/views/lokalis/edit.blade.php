...
@section('content')
    <div class="container">
        ...
        @endif
        <form id="lokalisForm" method="POST" action="/lokalis/{{ $lokalis->id }}/update">
            @csrf
            @method('PUT')
            ...
            <input type="text" name="markers" id="markers-data">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            const markers = @json($lokalis->markers->toArray());

            imgNotes.loadMarkers(markers);
